...
import { Bluetooth, PackageCheck, TrendingDownIcon, TrendingUp, TrendingUpIcon } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  {/* Trending Icon */}
  <TrendingUpIcon size={40} className={`${growthColorClass} mx-auto mb-2`} />
          ...
          <div className="flex gap-4 mt-5 flex-wrap">
           ...
           <div className="flex flex-col gap-8">
            ...
            <div className="flex items-center">
              <Button onClick={() => handleUpload()} className=" w-full sm: w2/3 md:w-1/2 ld:w-1/3 mx-auto">
                Upload
              </Button>
            </div>
            </div>
